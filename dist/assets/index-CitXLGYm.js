var m=Object.defineProperty;var w=(o,e,t)=>e in o?m(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var i=(o,e,t)=>w(o,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();class f{constructor(e,t={}){i(this,"canvas");i(this,"ctx");i(this,"dpr");i(this,"rectCache",null);i(this,"resizeObserver",null);i(this,"rafId",null);i(this,"lastFrameTime",0);i(this,"targetFrameTime",1e3/60);i(this,"eventHandlers",new Map);i(this,"isDrawing",!1);i(this,"lastPoint",null);i(this,"pointsBuffer",[]);i(this,"smoothingEnabled",!0);this.canvas=e;const r=e.getContext("2d",{alpha:!1,desynchronized:!0});if(!r)throw new Error("Canvas: Could not get 2D context");this.ctx=r,this.dpr=t.enableHighDPI!==!1&&window.devicePixelRatio||1,this.setupCanvas(t),this.setupEventListeners(),this.setupResizeHandling()}setupCanvas(e){const t=this.canvas.parentElement,r=e.width||(t?t.clientWidth:800),s=e.height||(t?t.clientHeight:600);this.setSize(r,s),this.ctx.lineCap=e.lineCap||"round",this.ctx.lineJoin=e.lineJoin||"round",e.backgroundColor!=="transparent"&&this.clear(e.backgroundColor||"#ffffff")}setupEventListeners(){this.canvas.addEventListener("pointerdown",this.handlePointerDown.bind(this),{passive:!1}),this.canvas.addEventListener("pointermove",this.handlePointerMove.bind(this),{passive:!1}),this.canvas.addEventListener("pointerup",this.handlePointerUp.bind(this),{passive:!1}),this.canvas.addEventListener("pointerleave",this.handlePointerUp.bind(this),{passive:!1}),this.canvas.addEventListener("pointercancel",this.handlePointerUp.bind(this),{passive:!1}),this.canvas.addEventListener("touchstart",e=>e.preventDefault(),{passive:!1}),this.canvas.addEventListener("touchmove",e=>e.preventDefault(),{passive:!1}),this.canvas.addEventListener("touchend",e=>e.preventDefault(),{passive:!1}),window.addEventListener("scroll",()=>{this.rectCache=null},{passive:!0})}setupResizeHandling(){typeof ResizeObserver<"u"&&this.canvas.parentElement?(this.resizeObserver=new ResizeObserver(e=>{for(const t of e){const{width:r,height:s}=t.contentRect;this.setSize(r,s),this.emit("resize",{type:"resize",x:0,y:0,rawX:0,rawY:0,pressure:0,pointerId:0,pointerType:"",isPrimary:!1,buttons:0,originalEvent:new PointerEvent("resize")})}}),this.resizeObserver.observe(this.canvas.parentElement)):window.addEventListener("resize",()=>{this.rectCache=null;const e=this.canvas.parentElement;e&&this.setSize(e.clientWidth,e.clientHeight)})}getPointerPos(e){this.rectCache||(this.rectCache=this.canvas.getBoundingClientRect());const t=this.rectCache;return{x:(e.clientX-t.left)*(this.canvas.width/t.width/this.dpr),y:(e.clientY-t.top)*(this.canvas.height/t.height/this.dpr)}}handlePointerDown(e){e.preventDefault(),this.isDrawing=!0,this.canvas.setPointerCapture(e.pointerId);const t=this.getPointerPos(e);this.lastPoint=t,this.pointsBuffer=[t];const r=this.createCanvasEvent("pointerdown",t,e);this.emit("pointerdown",r)}handlePointerMove(e){if(!this.isDrawing){this.rectCache=null;return}e.preventDefault();const t=this.getPointerPos(e);this.pointsBuffer.push(t),this.rafId===null&&(this.rafId=requestAnimationFrame(s=>{this.rafId=null,this.renderSmoothLine(s)}));const r=this.createCanvasEvent("pointermove",t,e);this.emit("pointermove",r)}handlePointerUp(e){if(!this.isDrawing)return;e.preventDefault(),this.isDrawing=!1,this.canvas.releasePointerCapture(e.pointerId);const t=this.getPointerPos(e);this.pointsBuffer.push(t),this.renderSmoothLine(performance.now(),!0),this.lastPoint=null,this.pointsBuffer=[];const r=this.createCanvasEvent("pointerup",t,e);this.emit("pointerup",r)}createCanvasEvent(e,t,r){return{type:e,x:t.x,y:t.y,rawX:r.clientX,rawY:r.clientY,pressure:r.pressure||.5,pointerId:r.pointerId,pointerType:r.pointerType,isPrimary:r.isPrimary,buttons:r.buttons,originalEvent:r}}renderSmoothLine(e,t=!1){const r=e-this.lastFrameTime;!t&&r<this.targetFrameTime||(this.lastFrameTime=e,!(this.pointsBuffer.length<2)&&(!this.smoothingEnabled||this.pointsBuffer.length<3?this.drawSimpleLines():this.drawSmoothLines()))}drawSimpleLines(){this.ctx.beginPath(),this.lastPoint&&this.ctx.moveTo(this.lastPoint.x,this.lastPoint.y);for(let e=0;e<this.pointsBuffer.length;e++)this.ctx.lineTo(this.pointsBuffer[e].x,this.pointsBuffer[e].y);this.ctx.stroke(),this.lastPoint=this.pointsBuffer[this.pointsBuffer.length-1],this.pointsBuffer=this.lastPoint?[this.lastPoint]:[]}drawSmoothLines(){if(!this.lastPoint)return;this.ctx.beginPath(),this.ctx.moveTo(this.lastPoint.x,this.lastPoint.y);for(let t=1;t<this.pointsBuffer.length-1;t++){const r=this.pointsBuffer[t],s=this.pointsBuffer[t+1],n=(r.x+s.x)/2,a=(r.y+s.y)/2;this.ctx.quadraticCurveTo(r.x,r.y,n,a)}const e=this.pointsBuffer[this.pointsBuffer.length-1];this.ctx.lineTo(e.x,e.y),this.ctx.stroke(),this.lastPoint=e,this.pointsBuffer=[this.lastPoint]}emit(e,t){const r=this.eventHandlers.get(e);r&&r.forEach(s=>{try{s(t)}catch(n){console.error("Canvas event handler error:",n)}})}setSize(e,t){this.canvas.width=Math.floor(e*this.dpr),this.canvas.height=Math.floor(t*this.dpr),this.canvas.style.width=`${e}px`,this.canvas.style.height=`${t}px`,this.ctx.scale(this.dpr,this.dpr),this.rectCache=null}getSize(){return{width:this.canvas.width/this.dpr,height:this.canvas.height/this.dpr}}getContext(){return this.ctx}getElement(){return this.canvas}clear(e){const{width:t,height:r}=this.getSize();e?(this.ctx.fillStyle=e,this.ctx.fillRect(0,0,t,r)):this.ctx.clearRect(0,0,t,r)}on(e,t){return this.eventHandlers.has(e)||this.eventHandlers.set(e,new Set),this.eventHandlers.get(e).add(t),()=>{var r;(r=this.eventHandlers.get(e))==null||r.delete(t)}}off(e,t){var r;(r=this.eventHandlers.get(e))==null||r.delete(t)}setSmoothing(e){this.smoothingEnabled=e}setMinDistance(e){}isCurrentlyDrawing(){return this.isDrawing}getLastPoint(){return this.lastPoint}getImageData(){return this.ctx.getImageData(0,0,this.canvas.width,this.canvas.height)}putImageData(e){this.ctx.putImageData(e,0,0)}toDataURL(e,t){return this.canvas.toDataURL(e,t)}dispose(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.eventHandlers.clear()}}class x{constructor(e,t,r){i(this,"canvasWrapper");i(this,"ctx");i(this,"toolManager");i(this,"historyManager");i(this,"isDrawing",!1);i(this,"startX",0);i(this,"startY",0);i(this,"snapshot",null);i(this,"currentPath",[]);this.toolManager=t,this.historyManager=r,this.canvasWrapper=new f(e,{enableHighDPI:!0,lineCap:"round",lineJoin:"round"}),this.ctx=this.canvasWrapper.getContext(),this.setupEventListeners(),this.initializeCanvas()}initializeCanvas(){this.ctx.strokeStyle=this.toolManager.getColor(),this.ctx.lineWidth=this.toolManager.getBrushSize(),this.ctx.fillStyle="#ffffff";const{width:e,height:t}=this.canvasWrapper.getSize();this.ctx.fillRect(0,0,e,t),this.historyManager.saveState()}setupEventListeners(){this.canvasWrapper.on("pointerdown",this.handlePointerDown.bind(this)),this.canvasWrapper.on("pointermove",this.handlePointerMove.bind(this)),this.canvasWrapper.on("pointerup",this.handlePointerUp.bind(this)),this.canvasWrapper.on("resize",this.handleResize.bind(this))}handlePointerDown(e){this.isDrawing=!0,this.startX=e.x,this.startY=e.y,this.currentPath=[{x:e.x,y:e.y}],this.snapshot=this.canvasWrapper.getImageData();const t=this.toolManager.getCurrentTool();(t==="brush"||t==="eraser")&&(this.ctx.beginPath(),this.ctx.moveTo(e.x,e.y),this.ctx.save(),t==="eraser"&&(this.ctx.globalCompositeOperation="destination-out"),this.ctx.arc(e.x,e.y,this.ctx.lineWidth/2,0,Math.PI*2),this.ctx.fill(),this.ctx.restore())}handlePointerMove(e){if(!this.isDrawing)return;this.currentPath.push({x:e.x,y:e.y});const t=this.toolManager.getCurrentTool();t==="brush"?(this.ctx.globalCompositeOperation="source-over",this.ctx.lineTo(e.x,e.y),this.ctx.stroke()):t==="eraser"?(this.ctx.globalCompositeOperation="destination-out",this.ctx.lineTo(e.x,e.y),this.ctx.stroke()):(t==="rectangle"||t==="circle"||t==="line")&&(this.snapshot&&this.canvasWrapper.putImageData(this.snapshot),this.drawShape(t,this.startX,this.startY,e.x,e.y))}handlePointerUp(e){if(!this.isDrawing)return;this.isDrawing=!1;const t=this.toolManager.getCurrentTool();t==="brush"||t==="eraser"?this.ctx.closePath():(t==="rectangle"||t==="circle"||t==="line")&&(this.snapshot&&this.canvasWrapper.putImageData(this.snapshot),this.drawShape(t,this.startX,this.startY,e.x,e.y)),this.ctx.globalCompositeOperation="source-over",this.historyManager.saveState(),this.currentPath=[]}handleResize(){}drawShape(e,t,r,s,n){switch(this.ctx.beginPath(),e){case"rectangle":this.ctx.rect(t,r,s-t,n-r),this.ctx.stroke();break;case"circle":{const a=Math.sqrt(Math.pow(s-t,2)+Math.pow(n-r,2));this.ctx.arc(t,r,a,0,Math.PI*2),this.ctx.stroke();break}case"line":this.ctx.moveTo(t,r),this.ctx.lineTo(s,n),this.ctx.stroke();break}this.ctx.closePath()}setTool(e){this.toolManager.setTool(e)}setColor(e){this.toolManager.setColor(e),this.ctx.strokeStyle=e,this.ctx.fillStyle=e}setBrushSize(e){this.toolManager.setBrushSize(e),this.ctx.lineWidth=e}clear(){const{width:e,height:t}=this.canvasWrapper.getSize();this.ctx.fillStyle="#ffffff",this.ctx.globalCompositeOperation="source-over",this.ctx.fillRect(0,0,e,t),this.historyManager.saveState()}download(e){const t=document.createElement("a");t.download=e,t.href=this.canvasWrapper.toDataURL("image/png"),t.click()}getCursorPosition(){return this.canvasWrapper.getLastPoint()}isCurrentlyDrawing(){return this.isDrawing}getCanvasSize(){return this.canvasWrapper.getSize()}dispose(){this.canvasWrapper.dispose()}}class h{constructor(){i(this,"size",12);i(this,"color","#dc2626");i(this,"isDrawing",!1)}setSize(e){this.size=e}setColor(e){this.color=e}getSize(){return this.size}getColor(){return this.color}}class b extends h{constructor(){super(...arguments);i(this,"name","Fırça");i(this,"type","brush")}onPointerDown(t,r,s){this.isDrawing=!0,t.globalCompositeOperation="source-over",t.strokeStyle=this.color,t.lineWidth=this.size,t.lineCap="round",t.lineJoin="round",t.beginPath(),t.moveTo(r,s),t.save(),t.fillStyle=this.color,t.arc(r,s,this.size/2,0,Math.PI*2),t.fill(),t.restore(),t.beginPath(),t.moveTo(r,s)}onPointerMove(t,r,s){this.isDrawing&&(t.globalCompositeOperation="source-over",t.strokeStyle=this.color,t.lineWidth=this.size,t.lineTo(r,s),t.stroke())}onPointerUp(t,r,s){this.isDrawing&&(this.isDrawing=!1,t.closePath())}}class y extends h{constructor(){super(...arguments);i(this,"name","Silgi");i(this,"type","eraser");i(this,"backgroundColor","#ffffff")}setBackgroundColor(t){this.backgroundColor=t}getBackgroundColor(){return this.backgroundColor}onPointerDown(t,r,s){this.isDrawing=!0,t.globalCompositeOperation="destination-out",t.lineWidth=this.size,t.lineCap="round",t.lineJoin="round",t.beginPath(),t.moveTo(r,s),t.save(),t.arc(r,s,this.size/2,0,Math.PI*2),t.fill(),t.restore(),t.beginPath(),t.moveTo(r,s)}onPointerMove(t,r,s){this.isDrawing&&(t.globalCompositeOperation="destination-out",t.lineWidth=this.size,t.lineTo(r,s),t.stroke())}onPointerUp(t,r,s){this.isDrawing&&(this.isDrawing=!1,t.closePath(),t.globalCompositeOperation="source-over")}}class k{constructor(){i(this,"currentTool","brush");i(this,"color","#dc2626");i(this,"brushSize",12);i(this,"tools",new Map);i(this,"listeners",new Set);const e=new b,t=new y;this.tools.set("brush",e),this.tools.set("eraser",t),this.updateToolSizes(),this.updateToolColors()}setTool(e){this.currentTool=e,this.notifyListeners()}getCurrentTool(){return this.currentTool}getToolInstance(e){return this.tools.get(e)}getCurrentToolInstance(){return this.tools.get(this.currentTool)}setColor(e){this.color=e,this.updateToolColors()}getColor(){return this.color}setBrushSize(e){this.brushSize=e,this.updateToolSizes()}getBrushSize(){return this.brushSize}updateToolSizes(){this.tools.forEach(e=>{e.setSize(this.brushSize)})}updateToolColors(){this.tools.forEach(e=>{e.setColor(this.color)})}onToolChange(e){return this.listeners.add(e),()=>{this.listeners.delete(e)}}notifyListeners(){this.listeners.forEach(e=>{e(this.currentTool)})}}class C{constructor(e){i(this,"canvas");i(this,"history",[]);i(this,"currentIndex",-1);i(this,"maxHistory",50);this.canvas=e}saveState(){const e=this.canvas.getContext("2d");if(!e)return;this.history=this.history.slice(0,this.currentIndex+1);const t=e.getImageData(0,0,this.canvas.width,this.canvas.height);this.history.push(t),this.history.length>this.maxHistory?this.history.shift():this.currentIndex++}undo(){return this.currentIndex<=0?!1:(this.currentIndex--,this.restoreState(),!0)}redo(){return this.currentIndex>=this.history.length-1?!1:(this.currentIndex++,this.restoreState(),!0)}restoreState(){const e=this.canvas.getContext("2d");!e||this.currentIndex<0||this.currentIndex>=this.history.length||e.putImageData(this.history[this.currentIndex],0,0)}canUndo(){return this.currentIndex>0}canRedo(){return this.currentIndex<this.history.length-1}}const S=[{name:"Kırmızı",value:"#dc2626"},{name:"Mavi",value:"#2563eb"},{name:"Yeşil",value:"#16a34a"},{name:"Sarı",value:"#facc15"},{name:"Turuncu",value:"#f97316"},{name:"Mor",value:"#9333ea"},{name:"Pembe",value:"#f472b6"},{name:"Kahverengi",value:"#92400e"},{name:"Siyah",value:"#0f172a"},{name:"Beyaz",value:"#ffffff"},{name:"Gri",value:"#94a3b8"},{name:"Turkuaz",value:"#22d3ee"}];class M{constructor(){i(this,"canvasManager",null);i(this,"toolManager",null);i(this,"historyManager",null);i(this,"currentColor","#dc2626");i(this,"currentBrushSize",12)}render(){const e=document.createElement("div");e.className="flex flex-col h-screen";const t=this.createHeader();e.appendChild(t);const r=document.createElement("div");r.className="flex flex-1 overflow-hidden";const s=this.createToolbar();r.appendChild(s);const n=this.createCanvasArea();r.appendChild(n);const a=this.createSidebar();r.appendChild(a),e.appendChild(r);const l=this.createFooter();return e.appendChild(l),setTimeout(()=>{this.initializeCanvas()},0),e}createHeader(){const e=document.createElement("header");return e.className="flex items-center justify-between border-b border-primary/10 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md px-6 py-3 shrink-0",e.innerHTML=`
    ...
    `,setTimeout(()=>{var t,r,s,n;(t=e.querySelector("#undo-btn"))==null||t.addEventListener("click",()=>this.handleUndo()),(r=e.querySelector("#redo-btn"))==null||r.addEventListener("click",()=>this.handleRedo()),(s=e.querySelector("#clear-btn"))==null||s.addEventListener("click",()=>this.handleClear()),(n=e.querySelector("#download-btn"))==null||n.addEventListener("click",()=>this.handleDownload())},0),e}createToolbar(){const e=document.createElement("aside");return e.className="w-20 bg-white dark:bg-background-dark border-r border-primary/10 flex flex-col items-center py-6 gap-6 shrink-0",[{type:"brush",icon:'<path d="m12 19 7-7 3 3-7 7-3-3z"/><path d="m18 13-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="m2 2 7.586 7.586"/><circle cx="11" cy="11" r="2"/>',label:"Fırça"},{type:"eraser",icon:'<path d="m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21"/><path d="M22 21H7"/><path d="m5 11 9 9"/>',label:"Silgi"},{type:"rectangle",icon:'<rect width="18" height="18" x="3" y="3" rx="2"/>',label:"Dikdörtgen"},{type:"circle",icon:'<circle cx="12" cy="12" r="10"/>',label:"Daire"},{type:"line",icon:'<path d="M5 12h14"/>',label:"Çizgi"}].forEach((r,s)=>{const n=s===0,a=document.createElement("div");a.className="group relative",a.innerHTML=`
      ...
      `,e.appendChild(a)}),setTimeout(()=>{e.querySelectorAll(".tool-btn").forEach(r=>{r.addEventListener("click",s=>{const n=s.currentTarget.dataset.tool;this.setTool(n),e.querySelectorAll(".tool-btn").forEach(a=>{a.className="p-3 hover:bg-slate-100 dark:hover:bg-white/5 text-slate-600 dark:text-slate-400 rounded-xl flex items-center justify-center transition-all tool-btn"}),s.currentTarget.className="p-3 bg-primary text-white shadow-lg shadow-primary/20 rounded-xl flex items-center justify-center transition-all tool-btn"})})},0),e}createCanvasArea(){const e=document.createElement("main");return e.className="flex-1 bg-background-light dark:bg-background-dark p-6 relative overflow-hidden",e.innerHTML=`
    ...
    `;const n=document.createElement("div");return n.className="mt-auto",n.innerHTML=`
    ...
    `;const n=document.createElement("section");n.className="flex-1 bg-slate-50 dark:bg-slate-900/50 p-8 flex items-center justify-center",n.innerHTML=`
    ...
    `,r.appendChild(s),r.appendChild(n);const a=document.createElement("div");return a.className="fixed bottom-6 right-6",a.innerHTML=`
    ...
    `,e.appendChild(t),e.appendChild(r),e.appendChild(s),setTimeout(()=>{const n=e.querySelector("#retry-btn");n==null||n.addEventListener("click",()=>this.props.onRetry())},0),e}}class u{constructor(){i(this,"container",null);i(this,"currentScreen","empty");i(this,"drawingScreen",null);i(this,"emptyStateScreen",null);i(this,"errorScreen",null)}mount(e){this.container=e,this.render()}render(){if(this.container)switch(this.container.innerHTML="",this.currentScreen){case"drawing":this.drawingScreen||(this.drawingScreen=new M),this.container.appendChild(this.drawingScreen.render());break;case"error":this.errorScreen||(this.errorScreen=new T({onRetry:()=>this.navigateTo("empty")})),this.container.appendChild(this.errorScreen.render());break;case"empty":default:this.emptyStateScreen||(this.emptyStateScreen=new z({onStartDrawing:()=>this.navigateTo("drawing")})),this.container.appendChild(this.emptyStateScreen.render());break}}navigateTo(e){this.currentScreen=e,this.render()}getCurrentScreen(){return this.currentScreen}}window.appNavigate=o=>{new u().navigateTo(o)};const P=new u;P.mount(document.getElementById("app"));
//# sourceMappingURL=index-CitXLGYm.js.map
