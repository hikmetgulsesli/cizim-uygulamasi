var p=Object.defineProperty;var g=(a,e,t)=>e in a?p(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var o=(a,e,t)=>g(a,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();class v{constructor(e,t,r){o(this,"canvas");o(this,"ctx");o(this,"toolManager");o(this,"historyManager");o(this,"isDrawing",!1);o(this,"startX",0);o(this,"startY",0);o(this,"snapshot",null);this.canvas=e;const s=e.getContext("2d");if(!s)throw new Error("Could not get 2D context");this.ctx=s,this.toolManager=t,this.historyManager=r,this.setupEventListeners(),this.initializeCanvas()}initializeCanvas(){this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.fillStyle="#ffffff",this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height),this.historyManager.saveState()}setupEventListeners(){this.canvas.addEventListener("pointerdown",this.handlePointerDown.bind(this)),this.canvas.addEventListener("pointermove",this.handlePointerMove.bind(this)),this.canvas.addEventListener("pointerup",this.handlePointerUp.bind(this)),this.canvas.addEventListener("pointerleave",this.handlePointerUp.bind(this)),this.canvas.addEventListener("touchstart",e=>e.preventDefault(),{passive:!1}),this.canvas.addEventListener("touchmove",e=>e.preventDefault(),{passive:!1})}getPointerPos(e){const t=this.canvas.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}handlePointerDown(e){this.isDrawing=!0;const t=this.getPointerPos(e);this.startX=t.x,this.startY=t.y,this.snapshot=this.ctx.getImageData(0,0,this.canvas.width,this.canvas.height);const r=this.toolManager.getCurrentTool();(r==="brush"||r==="eraser")&&(this.ctx.beginPath(),this.ctx.moveTo(t.x,t.y)),this.canvas.setPointerCapture(e.pointerId)}handlePointerMove(e){if(!this.isDrawing)return;const t=this.getPointerPos(e),r=this.toolManager.getCurrentTool();r==="brush"?(this.ctx.globalCompositeOperation="source-over",this.ctx.lineTo(t.x,t.y),this.ctx.stroke()):r==="eraser"?(this.ctx.globalCompositeOperation="destination-out",this.ctx.lineTo(t.x,t.y),this.ctx.stroke()):(r==="rectangle"||r==="circle"||r==="line")&&(this.snapshot&&this.ctx.putImageData(this.snapshot,0,0),this.drawShape(r,this.startX,this.startY,t.x,t.y))}handlePointerUp(e){if(!this.isDrawing)return;this.isDrawing=!1;const t=this.toolManager.getCurrentTool();(t==="brush"||t==="eraser")&&this.ctx.closePath(),this.ctx.globalCompositeOperation="source-over",this.historyManager.saveState(),this.canvas.releasePointerCapture(e.pointerId)}drawShape(e,t,r,s,i){switch(this.ctx.beginPath(),e){case"rectangle":this.ctx.rect(t,r,s-t,i-r),this.ctx.stroke();break;case"circle":{const n=Math.sqrt(Math.pow(s-t,2)+Math.pow(i-r,2));this.ctx.arc(t,r,n,0,Math.PI*2),this.ctx.stroke();break}case"line":this.ctx.moveTo(t,r),this.ctx.lineTo(s,i),this.ctx.stroke();break}this.ctx.closePath()}setTool(e){this.toolManager.setTool(e)}setColor(e){this.toolManager.setColor(e),this.ctx.strokeStyle=e}setBrushSize(e){this.toolManager.setBrushSize(e),this.ctx.lineWidth=e}clear(){this.ctx.fillStyle="#ffffff",this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height),this.historyManager.reset()}download(e){const t=document.createElement("a");t.download=e,t.href=this.canvas.toDataURL("image/png"),t.click()}}class h{constructor(){o(this,"size",12);o(this,"color","#dc2626");o(this,"isDrawing",!1)}setSize(e){this.size=e}setColor(e){this.color=e}getSize(){return this.size}getColor(){return this.color}}class m extends h{constructor(){super(...arguments);o(this,"name","Fırça");o(this,"type","brush")}onPointerDown(t,r,s){this.isDrawing=!0,t.globalCompositeOperation="source-over",t.strokeStyle=this.color,t.lineWidth=this.size,t.lineCap="round",t.lineJoin="round",t.beginPath(),t.moveTo(r,s),t.save(),t.fillStyle=this.color,t.arc(r,s,this.size/2,0,Math.PI*2),t.fill(),t.restore(),t.beginPath(),t.moveTo(r,s)}onPointerMove(t,r,s){this.isDrawing&&(t.globalCompositeOperation="source-over",t.strokeStyle=this.color,t.lineWidth=this.size,t.lineTo(r,s),t.stroke())}onPointerUp(t,r,s){this.isDrawing&&(this.isDrawing=!1,t.closePath())}}class w extends h{constructor(){super(...arguments);o(this,"name","Silgi");o(this,"type","eraser");o(this,"backgroundColor","#ffffff")}setBackgroundColor(t){this.backgroundColor=t}getBackgroundColor(){return this.backgroundColor}onPointerDown(t,r,s){this.isDrawing=!0,t.globalCompositeOperation="destination-out",t.lineWidth=this.size,t.lineCap="round",t.lineJoin="round",t.beginPath(),t.moveTo(r,s),t.save(),t.arc(r,s,this.size/2,0,Math.PI*2),t.fill(),t.restore(),t.beginPath(),t.moveTo(r,s)}onPointerMove(t,r,s){this.isDrawing&&(t.globalCompositeOperation="destination-out",t.lineWidth=this.size,t.lineTo(r,s),t.stroke())}onPointerUp(t,r,s){this.isDrawing&&(this.isDrawing=!1,t.closePath(),t.globalCompositeOperation="source-over")}}class x{constructor(){o(this,"currentTool","brush");o(this,"color","#dc2626");o(this,"brushSize",12);o(this,"tools",new Map);o(this,"listeners",new Set);const e=new m,t=new w;this.tools.set("brush",e),this.tools.set("eraser",t),this.updateToolSizes(),this.updateToolColors()}setTool(e){this.currentTool=e,this.notifyListeners()}getCurrentTool(){return this.currentTool}getToolInstance(e){return this.tools.get(e)}getCurrentToolInstance(){return this.tools.get(this.currentTool)}setColor(e){this.color=e,this.updateToolColors()}getColor(){return this.color}setBrushSize(e){this.brushSize=e,this.updateToolSizes()}getBrushSize(){return this.brushSize}updateToolSizes(){this.tools.forEach(e=>{e.setSize(this.brushSize)})}updateToolColors(){this.tools.forEach(e=>{e.setColor(this.color)})}onToolChange(e){return this.listeners.add(e),()=>{this.listeners.delete(e)}}notifyListeners(){this.listeners.forEach(e=>{e(this.currentTool)})}}class b{constructor(e,t=50){o(this,"canvas");o(this,"history",[]);o(this,"currentIndex",-1);o(this,"maxHistory");this.canvas=e,this.maxHistory=t}saveState(){const e=this.canvas.getContext("2d");if(!e)return;this.history=this.history.slice(0,this.currentIndex+1);const t=e.getImageData(0,0,this.canvas.width,this.canvas.height);this.history.push(t),this.history.length>this.maxHistory?this.history.shift():this.currentIndex++}undo(){return this.currentIndex<=0?!1:(this.currentIndex--,this.restoreState(),!0)}redo(){return this.currentIndex>=this.history.length-1?!1:(this.currentIndex++,this.restoreState(),!0)}reset(){this.canvas.getContext("2d")&&(this.history=[],this.currentIndex=-1,this.saveState())}restoreState(){const e=this.canvas.getContext("2d");!e||this.currentIndex<0||this.currentIndex>=this.history.length||e.putImageData(this.history[this.currentIndex],0,0)}canUndo(){return this.currentIndex>0}canRedo(){return this.currentIndex<this.history.length-1}getHistorySize(){return this.history.length}getCurrentIndex(){return this.currentIndex}getMaxHistory(){return this.maxHistory}}const c=[{name:"Kırmızı",value:"#dc2626"},{name:"Mavi",value:"#2563eb"},{name:"Yeşil",value:"#16a34a"},{name:"Sarı",value:"#facc15"},{name:"Turuncu",value:"#f97316"},{name:"Mor",value:"#9333ea"},{name:"Pembe",value:"#f472b6"},{name:"Kahverengi",value:"#92400e"},{name:"Siyah",value:"#0f172a"},{name:"Beyaz",value:"#ffffff"},{name:"Gri",value:"#94a3b8"},{name:"Turkuaz",value:"#22d3ee"}];class f{constructor(e="#dc2626",t){o(this,"container",null);o(this,"currentColor");o(this,"onColorChange");o(this,"colorGrid",null);o(this,"activeColorPreview",null);o(this,"activeColorName",null);o(this,"customColorInput",null);this.currentColor=e,this.onColorChange=t}render(){this.container=document.createElement("div"),this.container.className="color-picker";const e=this.createColorPaletteSection();this.container.appendChild(e);const t=this.createActiveColorSection();return this.container.appendChild(t),this.container}createColorPaletteSection(){var r;const e=document.createElement("div");e.innerHTML=`
    ...
    `,this.colorGrid=e.querySelector("#color-grid"),this.renderColorGrid();const t=e.querySelector("#custom-color-btn");return this.customColorInput=e.querySelector("#custom-color-input"),t==null||t.addEventListener("click",()=>{var s;(s=this.customColorInput)==null||s.click()}),(r=this.customColorInput)==null||r.addEventListener("input",s=>{const i=s.target.value;this.selectColor(i,"Özel Renk")}),e}renderColorGrid(){this.colorGrid&&(this.colorGrid.innerHTML=c.map(e=>`
        <button 
          ...
          title="${e.name}"
        ></button>
      `).join(""),this.colorGrid.querySelectorAll(".color-btn").forEach(e=>{e.addEventListener("click",t=>{const r=t.currentTarget.dataset.color,s=t.currentTarget.dataset.name;this.selectColor(r,s)})}))}createActiveColorSection(){const e=document.createElement("div");e.className="p-4 bg-primary/5 rounded-xl border border-primary/10 mt-6";const t=this.getColorName(this.currentColor);return e.innerHTML=`
    ...
    `,this.activeColorPreview=e.querySelector(".active-color-preview"),this.activeColorName=e.querySelector(".active-color-name"),e}selectColor(e,t){var s;this.currentColor=e,this.updateColorGridVisuals(),this.updateActiveColorPreview(e,t);const r=(s=this.container)==null?void 0:s.querySelector("#custom-color-preview");r&&(r.style.background=e),this.onColorChange(e,t)}updateColorGridVisuals(){this.colorGrid&&this.colorGrid.querySelectorAll(".color-btn").forEach(e=>{e.dataset.color===this.currentColor?e.className="w-10 h-10 rounded-full border-4 border-white dark:border-slate-800 ring-2 ring-primary shadow-sm color-btn transition-all hover:scale-110":e.className="w-10 h-10 rounded-full border-2 border-transparent shadow-sm color-btn transition-all hover:scale-110"})}updateActiveColorPreview(e,t){this.activeColorPreview&&(this.activeColorPreview.style.backgroundColor=e),this.activeColorName&&(this.activeColorName.textContent=t)}getColorName(e){const t=c.find(r=>r.value===e);return(t==null?void 0:t.name)||"Özel Renk"}getCurrentColor(){return this.currentColor}setColor(e,t){this.selectColor(e,t||this.getColorName(e))}}class y{constructor(e=()=>{}){o(this,"canvasManager",null);o(this,"toolManager",null);o(this,"historyManager",null);o(this,"colorPicker",null);o(this,"currentColor","#dc2626");o(this,"currentBrushSize",12);o(this,"onError");o(this,"keyboardHandler",null);this.onError=e}render(){const e=document.createElement("div");e.className="flex flex-col h-screen";const t=this.createHeader();e.appendChild(t);const r=document.createElement("div");r.className="flex flex-1 overflow-hidden";const s=this.createToolbar();r.appendChild(s);const i=this.createCanvasArea();r.appendChild(i);const n=this.createSidebar();r.appendChild(n),e.appendChild(r);const l=this.createFooter();return e.appendChild(l),setTimeout(()=>{this.initializeCanvas()},0),e}createHeader(){const e=document.createElement("header");return e.className="flex items-center justify-between border-b border-primary/10 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md px-6 py-3 shrink-0",e.innerHTML=`
      <div class="flex items-center gap-3">
    ...
    `,setTimeout(()=>{var t,r,s,i;(t=e.querySelector("#undo-btn"))==null||t.addEventListener("click",()=>this.handleUndo()),(r=e.querySelector("#redo-btn"))==null||r.addEventListener("click",()=>this.handleRedo()),(s=e.querySelector("#clear-btn"))==null||s.addEventListener("click",()=>this.handleClear()),(i=e.querySelector("#download-btn"))==null||i.addEventListener("click",()=>this.handleDownload())},0),e}createToolbar(){const e=document.createElement("aside");return e.className="w-20 bg-white dark:bg-background-dark border-r border-primary/10 flex flex-col items-center py-6 gap-6 shrink-0",[{type:"brush",icon:'<path d="m12 19 7-7 3 3-7 7-3-3z"/><path d="m18 13-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="m2 2 7.586 7.586"/><circle cx="11" cy="11" r="2"/>',label:"Fırça"},{type:"eraser",icon:'<path d="m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21"/><path d="M22 21H7"/><path d="m5 11 9 9"/>',label:"Silgi"},{type:"rectangle",icon:'<rect width="18" height="18" x="3" y="3" rx="2"/>',label:"Dikdörtgen"},{type:"circle",icon:'<circle cx="12" cy="12" r="10"/>',label:"Daire"},{type:"line",icon:'<path d="M5 12h14"/>',label:"Çizgi"}].forEach((r,s)=>{const i=s===0,n=document.createElement("div");n.className="group relative",n.innerHTML=`
      ...
      `,e.appendChild(n)}),setTimeout(()=>{e.querySelectorAll(".tool-btn").forEach(r=>{r.addEventListener("click",s=>{const i=s.currentTarget.dataset.tool;this.setTool(i),e.querySelectorAll(".tool-btn").forEach(n=>{n.className="p-3 hover:bg-slate-100 dark:hover:bg-white/5 text-slate-600 dark:text-slate-400 rounded-xl flex items-center justify-center transition-all tool-btn"}),s.currentTarget.className="p-3 bg-primary text-white shadow-lg shadow-primary/20 rounded-xl flex items-center justify-center transition-all tool-btn"})})},0),e}createCanvasArea(){const e=document.createElement("main");return e.className="flex-1 bg-background-light dark:bg-background-dark p-6 relative overflow-hidden",e.innerHTML=`
    ...
    `;const s=document.createElement("div");return s.className="mt-auto",s.innerHTML=`
    ...
    `,e.appendChild(r),e.appendChild(s),setTimeout(()=>{const i=e.querySelector("#brush-size-slider"),n=e.querySelector("#brush-size-display");i==null||i.addEventListener("input",l=>{const d=parseInt(l.target.value);this.setBrushSize(d),n&&(n.textContent=`${d}px`)})},0),e}createFooter(){const e=document.createElement("footer");return e.className="h-8 bg-slate-50 dark:bg-background-dark border-t border-primary/10 px-6 flex items-center justify-between text-[10px] text-slate-400 font-medium",e.innerHTML=`
    ...
    `,e}initializeCanvas(){try{const e=document.getElementById("drawing-canvas");if(!(e instanceof HTMLCanvasElement))throw new Error('Canvas element with id "drawing-canvas" not found or is not a valid canvas element.');const t=e;if(!t.getContext("2d"))throw new Error("Could not get 2D context");const s=document.getElementById("canvas-wrapper");if(s){const i=s.getBoundingClientRect();t.width=i.width,t.height=i.height}this.historyManager=new b(t),this.toolManager=new x,this.canvasManager=new v(t,this.toolManager,this.historyManager),this.canvasManager.setTool("brush"),this.canvasManager.setColor(this.currentColor),this.canvasManager.setBrushSize(this.currentBrushSize),this.keyboardHandler||this.setupKeyboardShortcuts()}catch(e){console.error("Canvas initialization error:",e),this.onError()}}setupKeyboardShortcuts(){this.keyboardHandler=e=>{e.ctrlKey&&e.key==="z"&&!e.shiftKey?(e.preventDefault(),this.handleUndo()):(e.ctrlKey&&e.key==="z"&&e.shiftKey||e.ctrlKey&&e.key==="y")&&(e.preventDefault(),this.handleRedo())},document.addEventListener("keydown",this.keyboardHandler)}setTool(e){var t;(t=this.canvasManager)==null||t.setTool(e)}setColor(e,t){var r;this.currentColor=e,(r=this.canvasManager)==null||r.setColor(e)}setBrushSize(e){var t;this.currentBrushSize=e,(t=this.canvasManager)==null||t.setBrushSize(e)}handleUndo(){var e;(e=this.historyManager)==null||e.undo()}handleRedo(){var e;(e=this.historyManager)==null||e.redo()}handleClear(){var e;confirm("Tuvali temizlemek istediğinizden emin misiniz?")&&((e=this.canvasManager)==null||e.clear())}handleDownload(){var e;(e=this.canvasManager)==null||e.download("cizim.png")}}class k{constructor(e){o(this,"props");this.props=e}render(){const e=document.createElement("div");e.className="flex h-screen w-full flex-col overflow-hidden";const t=document.createElement("header");t.className="flex items-center justify-between border-b border-primary/10 bg-white dark:bg-background-dark px-6 py-3",t.innerHTML=`
      <div class="flex items-center gap-3">
    ...
    `,r.appendChild(s),r.appendChild(i);const n=document.createElement("div");return n.className="fixed bottom-6 right-6",n.innerHTML=`
    ...
    `,e.appendChild(t),e.appendChild(r),e.appendChild(s),setTimeout(()=>{const i=e.querySelector("#retry-btn");i==null||i.addEventListener("click",()=>this.props.onRetry())},0),e}}class u{constructor(){o(this,"container",null);o(this,"currentScreen","empty");o(this,"drawingScreen",null);o(this,"emptyStateScreen",null);o(this,"errorScreen",null);o(this,"canvasError",!1);o(this,"globalHandlersInstalled",!1)}mount(e){this.container=e,this.setupGlobalErrorHandler(),this.render()}setupGlobalErrorHandler(){this.globalHandlersInstalled||(this.globalHandlersInstalled=!0,window.addEventListener("error",e=>{const t=e.message||"";(t.includes("canvas")||t.includes("Canvas")||t.includes("2D context"))&&(this.canvasError=!0,this.navigateTo("error"))}),window.addEventListener("unhandledrejection",e=>{const t=String(e.reason);(t.includes("canvas")||t.includes("Canvas")||t.includes("2D context"))&&(this.canvasError=!0,this.navigateTo("error"))}))}render(){if(this.container)switch(this.container.innerHTML="",this.currentScreen){case"drawing":try{this.drawingScreen||(this.drawingScreen=new y(()=>{this.canvasError=!0,this.navigateTo("error")})),this.container.appendChild(this.drawingScreen.render())}catch(e){console.error("Canvas initialization failed:",e),this.canvasError=!0,this.currentScreen="error",this.render()}break;case"error":this.errorScreen||(this.errorScreen=new C({onRetry:()=>{this.canvasError=!1,this.navigateTo("empty")}})),this.container.appendChild(this.errorScreen.render());break;case"empty":default:this.emptyStateScreen||(this.emptyStateScreen=new k({onStartDrawing:()=>this.navigateTo("drawing")})),this.container.appendChild(this.emptyStateScreen.render());break}}navigateTo(e){this.currentScreen=e,this.render()}getCurrentScreen(){return this.currentScreen}hasCanvasError(){return this.canvasError}}window.appNavigate=a=>{new u().navigateTo(a)};const S=new u;S.mount(document.getElementById("app"));
//# sourceMappingURL=index-CgG0ATV1.js.map
